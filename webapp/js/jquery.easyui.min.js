...
(function($){
function _1(e){
var _2=$.data(e.data.target,"draggable1").options;
var _3=e.data;
...
function _6(e){
var _7=$.data(e.data.target,"draggable1").options;
var _8=$.data(e.data.target,"draggable1").proxy;
if(_8){
_8.css("cursor",_7.cursor);
}else{
_8=$(e.data.target);
$.data(e.data.target,"draggable1").handle.css("cursor",_7.cursor);
}
_8.css({left:e.data.left,top:e.data.top});
};
function _9(e){
var _a=$.data(e.data.target,"draggable1").options;
var _b=$(".droppable1").filter(function(){
return e.data.target!=this;
}).filter(function(){
var _c=$.data(this,"droppable1").options.accept;
if(_c){
...
$.data(e.data.target,"draggable1").droppable1s=_b;
var _d=$.data(e.data.target,"draggable1").proxy;
if(!_d){
if(_a.proxy){
if(_a.proxy=="clone"){
...
$.data(e.data.target,"draggable1").proxy=_d;
}else{
_d=$(e.data.target);
}
}
...
function _e(e){
_1(e);
if($.data(e.data.target,"draggable1").options.onDrag.call(e.data.target,e)!=false){
_6(e);
}
var _f=e.data.target;
$.data(e.data.target,"draggable1").droppable1s.each(function(){
var _10=$(this);
var p2=$(this).offset();
...
function _11(e){
_1(e);
var _12=$.data(e.data.target,"draggable1").proxy;
var _13=$.data(e.data.target,"draggable1").options;
if(_13.revert){
if(_14()==true){
_15();
...
$.data(e.data.target,"draggable1").proxy=null;
};
function _14(){
var _16=false;
$.data(e.data.target,"draggable1").droppable1s.each(function(){
...
$.fn.draggable1=function(_18,_19){
if(typeof _18=="string"){
return $.fn.draggable1.methods[_18](this,_19);
}
return this.each(function(){
var _1a;
var _1b=$.data(this,"draggable1");
if(_1b){
_1b.handle.unbind(".draggable1");
_1a=$.extend(_1b.options,_18);
}else{
_1a=$.extend({},$.fn.draggable1.defaults,_18||{});
}
...
$.data(this,"draggable1",{options:_1a,handle:_1c});
_1c.bind("mousedown.draggable1",{target:this},_1d);
_1c.bind("mousemove.draggable1",{target:this},_1e);
function _1d(e){
if(_1f(e)==false){
return;
}
...
$(document).bind("mousedown.draggable1",_21,_9);
$(document).bind("mousemove.draggable1",_21,_e);
$(document).bind("mouseup.draggable1",_21,_11);
};
function _1e(e){
if(_1f(e)){
...
$.fn.draggable1.defaults={proxy:null,revert:false,cursor:"move",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,onBeforeDrag:function(e){
...
(function($){
function _25(_26){
$(_26).addClass("droppable1");
$(_26).bind("_dragenter",function(e,_27){
$.data(_26,"droppable1").options.onDragEnter.apply(_26,[e,_27]);
});
$(_26).bind("_dragleave",function(e,_28){
$.data(_26,"droppable1").options.onDragLeave.apply(_26,[e,_28]);
});
$(_26).bind("_dragover",function(e,_29){
$.data(_26,"droppable1").options.onDragOver.apply(_26,[e,_29]);
});
$(_26).bind("_drop",function(e,_2a){
$.data(_26,"droppable1").options.onDrop.apply(_26,[e,_2a]);
});
};
$.fn.droppable1=function(_2b,_2c){
if(typeof _2b=="string"){
return $.fn.droppable1.methods[_2b](this,_2c);
}
_2b=_2b||{};
return this.each(function(){
var _2d=$.data(this,"droppable1");
if(_2d){
$.extend(_2d.options,_2b);
}else{
_25(this);
$.data(this,"droppable1",{options:$.extend({},$.fn.droppable1.defaults,_2b)});
}
});
};
$.fn.droppable1.methods={};
$.fn.droppable1.defaults={accept:null,onDragEnter:function(e,_2e){
...
(function($){
$.fn.resizable1=function(_32,_33){
if(typeof _32=="string"){
return $.fn.resizable1.methods[_32](this,_33);
}
function _34(e){
var _35=e.data;
var _36=$.data(_35.target,"resizable1").options;
...
function _3c(e){
$.data(e.data.target,"resizable1").options.onStartResize.call(e.data.target,e);
return false;
};
function _3d(e){
_34(e);
if($.data(e.data.target,"resizable1").options.onResize.call(e.data.target,e)!=false){
_39(e);
}
return false;
};
...
_34(e,true);
_39(e);
$.data(e.data.target,"resizable1").options.onStopResize.call(e.data.target,e);
$(document).unbind(".resizable1");
$("body").css("cursor","default");
return false;
};
return this.each(function(){
var _3f=null;
var _40=$.data(this,"resizable1");
if(_40){
$(this).unbind(".resizable1");
_3f=$.extend(_40.options,_32||{});
}else{
_3f=$.extend({},$.fn.resizable1.defaults,_32||{});
$.data(this,"resizable1",{options:_3f});
}
if(_3f.disabled==true){
return;
}
var _41=this;
$(this).bind("mousemove.resizable1",function(e){
var dir=_42(e);
if(dir==""){
...
}).bind("mousedown.resizable1",function(e){
var dir=_42(e);
if(dir==""){
return;
}
...
$(document).bind("mousedown.resizable1",_43,_3c);
$(document).bind("mousemove.resizable1",_43,_3d);
$(document).bind("mouseup.resizable1",_43,_3e);
$("body").css("cursor",dir+"-resize");
}).bind("mouseleave.resizable1",function(){
$(_41).css("cursor","default");
});
function _42(e){
var dir="";
...
$.fn.resizable1.methods={};
$.fn.resizable1.defaults={disabled:false,handles:"n, e, s, w, ne, se, sw, nw, all",minWidth:10,minHeight:10,maxWidth:10000,maxHeight:10000,edge:5,onStartResize:function(e){
},onResize:function(e){
...
return false;
}).bind("contextmenu1.tree",function(e){
...
_8d.draggable1("disable");
_8d.css("cursor","pointer");
};
function _8e(_8f){
var _90=$.data(_8f,"tree").options;
var _91=$.data(_8f,"tree").tree;
_91.find("div.tree-node").draggable1({disabled:false,revert:true,cursor:"pointer",proxy:function(_92){
var p=$("<div class=\"tree-node-proxy tree-dnd-no\"></div>").appendTo("body");
p.html($(_92).find(".tree-title").html());
p.hide();
return p;
},deltaX:15,deltaY:15,onBeforeDrag:function(){
$(this).next("ul").find("div.tree-node").droppable1({accept:"no-accept"});
...
$(this).next("ul").find("div.tree-node").droppable1({accept:"div.tree-node"});
}}).droppable1({accept:"div.tree-node",onDragOver:function(e,_93){
var _94=_93.pageY;
var top=$(this).offset().top;
var _95=top+$(this).outerHeight();
$(_93).draggable1("proxy").removeClass("tree-dnd-no").addClass("tree-dnd-yes");
...
$(_96).draggable1("proxy").removeClass("tree-dnd-yes").addClass("tree-dnd-no");
$(this).removeClass("tree-node-append tree-node-top tree-node-bottom");
...
},plugins:["linkbutton","menu1","menu1button","splitbutton","progressbar1","tree","combobox","combotree","numberbox","validatebox","searchbox","numberspinner","timespinner","calendar","datebox","datetimebox","layout","panel","datagrid","propertygrid","treegrid","tabs1","accordion1","window","dialog1"],parse:function(_152){
var aa=[];
...
(function($){
function init(_154){
$(_154).addClass("progressbar1");
$(_154).html("<div class=\"progressbar1-text\"></div><div class=\"progressbar1-value\">&nbsp;</div>");
return $(_154);
};
function _155(_156,_157){
var opts=$.data(_156,"progressbar1").options;
var bar=$.data(_156,"progressbar1").bar;
if(_157){
opts.width=_157;
}
if($.boxModel==true){
...
bar.find("div.progressbar1-text").width(bar.width());
};
$.fn.progressbar1=function(_158,_159){
if(typeof _158=="string"){
var _15a=$.fn.progressbar1.methods[_158];
if(_15a){
...
_158=_158||{};
return this.each(function(){
var _15b=$.data(this,"progressbar1");
if(_15b){
$.extend(_15b.options,_158);
}else{
_15b=$.data(this,"progressbar1",{options:$.extend({},$.fn.progressbar1.defaults,$.fn.progressbar1.parseOptions(this),_158),bar:init(this)});
}
$(this).progressbar1("setValue",_15b.options.value);
_155(this);
});
};
$.fn.progressbar1.methods={options:function(jq){
return $.data(jq[0],"progressbar1").options;
},resize:function(jq,_15c){
return jq.each(function(){
_155(this,_15c);
});
},getValue:function(jq){
return $.data(jq[0],"progressbar1").options.value;
...
return jq.each(function(){
var opts=$.data(this,"progressbar1").options;
var text=opts.text.replace(/{value}/,_15d);
var _15e=opts.value;
opts.value=_15d;
$(this).find("div.progressbar1-value").width(_15d+"%");
$(this).find("div.progressbar1-text").html(text);
if(_15e!=_15d){
opts.onChange.call(this,_15d,_15e);
}
});
}};
$.fn.progressbar1.parseOptions=function(_15f){
var t=$(_15f);
return {width:(parseInt(_15f.style.width)||undefined),value:(t.attr("value")?parseInt(t.attr("value")):undefined),text:t.attr("text")};
};
$.fn.progressbar1.defaults={width:"auto",value:0,text:"{value}%",onChange:function(_160,_161){
}};
})(jQuery);
(function($){
function _162(node){
...
function _17d(_17e){
$(_17e).find("div.panel:visible,div.accordion1:visible,div.tabs1-container:visible,div.layout:visible").each(function(){
...
$("body").children("div.panel,div.accordion1,div.tabs1-container,div.layout").triggerHandler("_resize");
}
_1a2=true;
TO=false;
},200);
...
_1c6.window.draggable1({handle:">div.panel-header>div.panel-title",disabled:_1c6.options.draggable1==false,onStartDrag:function(e){
if(_1c6.mask){
...
_1c6.window.resizable1({disabled:_1c6.options.resizable1==false,onStartResize:function(e){
...
var t=$(_1cf);
return $.extend({},$.fn.panel.parseOptions(_1cf),{draggable1:(t.attr("draggable1")?t.attr("draggable1")=="true":undefined),resizable1:(t.attr("resizable1")?t.attr("resizable1")=="true":undefined),shadow:(t.attr("shadow")?t.attr("shadow")=="true":undefined),modal:(t.attr("modal")?t.attr("modal")=="true":undefined),inline:(t.attr("inline")?t.attr("inline")=="true":undefined)});
};
$.fn.window.defaults=$.extend({},$.fn.panel.defaults,{zIndex:9000,draggable1:true,resizable1:true,shadow:true,modal:false,inline:false,title:"New Window",collapsible:true,minimizable:true,maximizable:true,closable:true,closed:false});
})(jQuery);
(function($){
function _1d0(_1d1){
var t=$(_1d1);
t.wrapInner("<div class=\"dialog1-content\"></div>");
var _1d2=t.children("div.dialog1-content");
...
function _1d3(_1d4){
var opts=$.data(_1d4,"dialog1").options;
var _1d5=$.data(_1d4,"dialog1").contentPanel;
if(opts.toolbar){
if(typeof opts.toolbar=="string"){
$(opts.toolbar).addClass("dialog1-toolbar").prependTo(_1d4);
$(opts.toolbar).show();
}else{
$(_1d4).find("div.dialog1-toolbar").remove();
var _1d6=$("<div class=\"dialog1-toolbar\"></div>").prependTo(_1d4);
for(var i=0;i<opts.toolbar.length;i++){
var p=opts.toolbar[i];
if(p=="-"){
_1d6.append("<div class=\"dialog1-tool-separator\"></div>");
}else{
...
$(opts.buttons).addClass("dialog1-button").appendTo(_1d4);
$(opts.buttons).show();
}else{
$(_1d4).find("div.dialog1-button").remove();
var _1d7=$("<div class=\"dialog1-button\"></div>").appendTo(_1d4);
...
_1d5.panel("resize",{width:_1dd.width(),height:(_1dc=="auto")?"auto":_1dd.height()-_1dd.find(">div.dialog1-toolbar").outerHeight()-_1dd.find(">div.dialog1-button").outerHeight()});
if(opts.onResize){
...
var _1e0=$.data(_1df,"dialog1").contentPanel;
_1e0.panel("refresh",href);
};
$.fn.dialog1=function(_1e1,_1e2){
if(typeof _1e1=="string"){
var _1e3=$.fn.dialog1.methods[_1e1];
if(_1e3){
...
_1e1=_1e1||{};
return this.each(function(){
var _1e4=$.data(this,"dialog1");
if(_1e4){
$.extend(_1e4.options,_1e1);
}else{
$.data(this,"dialog1",{options:$.extend({},$.fn.dialog1.defaults,$.fn.dialog1.parseOptions(this),_1e1),contentPanel:_1d0(this)});
}
_1d3(this);
});
};
$.fn.dialog1.methods={options:function(jq){
var _1e5=$.data(jq[0],"dialog1").options;
...
var _1e7=$.data(jq[0],"dialog1").contentPanel;
return _1e5;
},dialog1:function(jq){
...
$.fn.dialog1.parseOptions=function(_1e8){
var t=$(_1e8);
return $.extend({},$.fn.window.parseOptions(_1e8),{toolbar:t.attr("toolbar"),buttons:t.attr("buttons")});
};
$.fn.dialog1.defaults=$.extend({},$.fn.window.defaults,{title:"New Dialog",collapsible:false,minimizable:false,maximizable:false,resizable1:false,toolbar:null,buttons:null});
})(jQuery);
(function($){
...
win.window({title:_1ee,noheader:(_1ee?false:true),width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,resizable1:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
...
win.window({title:opts.title,width:opts.width,height:opts.height,collapsible:false,minimizable:false,maximizable:false,shadow:false,draggable1:false,resizable1:false,closed:true,onBeforeOpen:function(){
...
bar.progressbar1({text:opts.text});
win.window({closable:false});
if(opts.interval){
win[0].timer=setInterval(function(){
var v=bar.progressbar1("getValue");
v+=10;
if(v>100){
v=0;
}
bar.progressbar1("setValue",v);
},opts.interval);
}
}};
...
(function($){
function _200(_201){
var opts=$.data(_201,"accordion1").options;
var _202=$.data(_201,"accordion1").panels;
var cc=$(_201);
if(opts.fit==true){
var p=cc.parent();
opts.width=p.width();
...
function _207(_208){
var _209=$.data(_208,"accordion1").panels;
...
var _20f=$.data(_20c,"accordion1").panels;
...
function _211(_212){
var cc=$(_212);
cc.addClass("accordion1");
if(cc.attr("border")=="false"){
cc.addClass("accordion1-noborder");
}else{
cc.removeClass("accordion1-noborder");
}
...
var opts=$.data(_212,"accordion1").options;
if(opts.fit==true||_215){
_200(_212);
}
return false;
});
return {accordion1:cc,panels:_214};
};
function _216(_217,pp,_218){
pp.panel($.extend({},_218,{collapsible:false,minimizable:false,maximizable:false,closable:false,doSize:false,tools:[{iconCls:"accordion1-collapse",handler:function(){
var _219=$.data(_217,"accordion1").options.animate;
...
_21a.removeClass("accordion1-header-selected");
_21a.find(".accordion1-collapse").triggerHandler("click");
}
var _21a=pp.panel("header");
_21a.addClass("accordion1-header-selected");
_21a.find("div.accordion1-collapse").removeClass("accordion1-expand");
},onExpand:function(){
var opts=$.data(_217,"accordion1").options;
opts.onSelect.call(_217,pp.panel("options").title);
},onBeforeCollapse:function(){
var _21b=pp.panel("header");
_21b.removeClass("accordion1-header-selected");
_21b.find("div.accordion1-collapse").addClass("accordion1-expand");
}}));
pp.panel("body").addClass("accordion1-body");
pp.panel("header").addClass("accordion1-header").click(function(){
$(this).find(".accordion1-collapse").triggerHandler("click");
return false;
});
};
function _21c(_21d,_21e){
var opts=$.data(_21d,"accordion1").options;
var _21f=$.data(_21d,"accordion1").panels;
var curr=_207(_21d);
...
if(curr){
curr.panel("header").addClass("accordion1-header-selected");
opts.onSelect.call(_21d,curr.panel("options").title);
}
}
};
function _221(_222){
var _223=$.data(_222,"accordion1").panels;
for(var i=0;i<_223.length;i++){
_223[i].stop(true,true);
}
};
function add(_224,_225){
var opts=$.data(_224,"accordion1").options;
var _226=$.data(_224,"accordion1").panels;
_221(_224);
...
var opts=$.data(_228,"accordion1").options;
var _22a=$.data(_228,"accordion1").panels;
_221(_228);
...
$.fn.accordion1=function(_22c,_22d){
if(typeof _22c=="string"){
return $.fn.accordion1.methods[_22c](this,_22d);
}
_22c=_22c||{};
return this.each(function(){
var _22e=$.data(this,"accordion1");
var opts;
if(_22e){
opts=$.extend(_22e.options,_22c);
_22e.opts=opts;
}else{
opts=$.extend({},$.fn.accordion1.defaults,$.fn.accordion1.parseOptions(this),_22c);
var r=_211(this);
$.data(this,"accordion1",{options:opts,accordion1:r.accordion1,panels:r.panels});
}
_200(this);
_21c(this);
});
};
$.fn.accordion1.methods={options:function(jq){
return $.data(jq[0],"accordion1").options;
},panels:function(jq){
return $.data(jq[0],"accordion1").panels;
},resize:function(jq){
return jq.each(function(){
_200(this);
});
...
$.fn.accordion1.parseOptions=function(_232){
var t=$(_232);
...
$.fn.accordion1.defaults={width:"auto",height:"auto",fit:false,border:true,animate:true,onSelect:function(_233){
},onAdd:function(_234){
...
(function($){
function _237(_238){
var _239=$(">div.tabs1-header",_238);
var _23a=0;
$("ul.tabs1 li",_239).each(function(){
_23a+=$(this).outerWidth(true);
});
var _23b=$("div.tabs1-wrap",_239).width();
var _23c=parseInt($("ul.tabs1",_239).css("padding-left"));
return _23a-_23b+_23c;
};
function _23d(_23e){
var opts=$.data(_23e,"tabs1").options;
var _23f=$(_23e).children("div.tabs1-header");
var tool=_23f.children("div.tabs1-tool");
var _240=_23f.children("div.tabs1-scroller-left");
var _241=_23f.children("div.tabs1-scroller-right");
var wrap=_23f.children("div.tabs1-wrap");
...
tool.height(_242);
var _243=0;
$("ul.tabs1 li",_23f).each(function(){
...
function _245(_246){
var opts=$.data(_246,"tabs1").options;
var _247=$(_246).children("div.tabs1-header");
var _248=_247.children("div.tabs1-tool");
_248.remove();
if(opts.tools){
_248=$("<div class=\"tabs1-tool\"></div>").appendTo(_247);
...
function _249(_24a){
var opts=$.data(_24a,"tabs1").options;
var cc=$(_24a);
if(opts.fit==true){
var p=cc.parent();
opts.width=p.width();
...
var _24b=$(">div.tabs1-header",_24a);
if($.boxModel==true){
...
_23d(_24a);
var _24c=$(">div.tabs1-panels",_24a);
...
function _250(_251){
var opts=$.data(_251,"tabs1").options;
var tab=_252(_251);
if(tab){
var _253=$(_251).find(">div.tabs1-panels");
...
function _256(_257){
var cc=$(_257);
cc.addClass("tabs1-container");
cc.wrapInner("<div class=\"tabs1-panels\"/>");
$("<div class=\"tabs1-header\">"+"<div class=\"tabs1-scroller-left\"></div>"+"<div class=\"tabs1-scroller-right\"></div>"+"<div class=\"tabs1-wrap\">"+"<ul class=\"tabs1\"></ul>"+"</div>"+"</div>").prependTo(_257);
var tabs1=[];
var tp=cc.children("div.tabs1-panels");
...
var opts=$.data(_257,"tabs1").options;
...
function _259(_25a){
var opts=$.data(_25a,"tabs1").options;
var _25b=$(">div.tabs1-header",_25a);
var _25c=$(">div.tabs1-panels",_25a);
if(opts.plain==true){
_25b.addClass("tabs1-header-plain");
}else{
_25b.removeClass("tabs1-header-plain");
}
if(opts.border==true){
_25b.removeClass("tabs1-header-noborder");
_25c.removeClass("tabs1-panels-noborder");
}else{
_25b.addClass("tabs1-header-noborder");
_25c.addClass("tabs1-panels-noborder");
}
$(".tabs1-scroller-left",_25b).unbind(".tabs1").bind("click.tabs1",function(){
var wrap=$(".tabs1-wrap",_25b);
var pos=wrap.scrollLeft()-opts.scrollIncrement;
wrap.animate({scrollLeft:pos},opts.scrollDuration);
});
$(".tabs1-scroller-right",_25b).unbind(".tabs1").bind("click.tabs1",function(){
var wrap=$(".tabs1-wrap",_25b);
var pos=Math.min(wrap.scrollLeft()+opts.scrollIncrement,_237(_25a));
wrap.animate({scrollLeft:pos},opts.scrollDuration);
});
var tabs1=$.data(_25a,"tabs1").tabs1;
for(var i=0,len=tabs1.length;i<len;i++){
var _25d=tabs1[i];
var tab=_25d.panel("options").tab;
var _25e=_25d.panel("options").title;
tab.unbind(".tabs1").bind("click.tabs1",{title:_25e},function(e){
_26a(_25a,e.data.title);
}).bind("contextmenu1.tabs1",{title:_25e},function(e){
opts.onContextMenu.call(_25a,e,e.data.title);
});
tab.find("a.tabs1-close").unbind(".tabs1").bind("click.tabs1",{title:_25e},function(e){
...
$.data(_261,"tabs1").options.onLoad.call(_261,pp);
}}));
var opts=pp.panel("options");
var _263=$(">div.tabs1-header",_261);
var tabs1=$("ul.tabs1",_263);
var tab=$("<li></li>").appendTo(tabs1);
var _264=$("<a href=\"javascript:void(0)\" class=\"tabs1-inner\"></a>").appendTo(tab);
var _265=$("<span class=\"tabs1-title\"></span>").html(opts.title).appendTo(_264);
var _266=$("<span class=\"tabs1-icon\"></span>").appendTo(_264);
if(opts.closable){
_265.addClass("tabs1-closable");
$("<a href=\"javascript:void(0)\" class=\"tabs1-close\"></a>").appendTo(tab);
}
if(opts.iconCls){
_265.addClass("tabs1-with-icon");
_266.addClass(opts.iconCls);
}
opts.tab=tab;
};
function _267(_268,_269){
var opts=$.data(_268,"tabs1").options;
var tabs1=$.data(_268,"tabs1").tabs1;
var pp=$("<div></div>").appendTo($(">div.tabs1-panels",_268));
tabs1.push(pp);
_260(_268,pp,_269);
...
var _26e=$.data(_26c,"tabs1").selectHis;
var pp=_26d.tab;
var _26f=pp.panel("options").title;
pp.panel($.extend({},_26d.options,{iconCls:(_26d.options.icon?_26d.options.icon:undefined)}));
var opts=pp.panel("options");
var tab=opts.tab;
tab.find("span.tabs1-icon").attr("class","tabs1-icon");
tab.find("a.tabs1-close").remove();
tab.find("span.tabs1-title").html(opts.title);
if(opts.closable){
tab.find("span.tabs1-title").addClass("tabs1-closable");
$("<a href=\"javascript:void(0)\" class=\"tabs1-close\"></a>").appendTo(tab);
}else{
tab.find("span.tabs1-title").removeClass("tabs1-closable");
}
if(opts.iconCls){
tab.find("span.tabs1-title").addClass("tabs1-with-icon");
tab.find("span.tabs1-icon").addClass(opts.iconCls);
}else{
tab.find("span.tabs1-title").removeClass("tabs1-with-icon");
}
if(_26f!=opts.title){
...
_259(_26c);
$.data(_26c,"tabs1").options.onUpdate.call(_26c,opts.title);
};
function _25f(_270,_271){
var opts=$.data(_270,"tabs1").options;
var tabs1=$.data(_270,"tabs1").tabs1;
var _272=$.data(_270,"tabs1").selectHis;
if(!_273(_270,_271)){
return;
}
...
if(tabs1.length){
_26a(_270,tabs1[0].panel("options").title);
}
}
};
function _274(_276,_277,_278){
var tabs1=$.data(_276,"tabs1").tabs1;
...
function _252(_279){
var tabs1=$.data(_279,"tabs1").tabs1;
for(var i=0;i<tabs1.length;i++){
var tab=tabs1[i];
...
function _27a(_27b){
var tabs1=$.data(_27b,"tabs1").tabs1;
for(var i=0;i<tabs1.length;i++){
var tab=tabs1[i];
...
if(tabs1.length){
_26a(_27b,tabs1[0].panel("options").title);
}
};
function _26a(_27c,_27d){
var opts=$.data(_27c,"tabs1").options;
var tabs1=$.data(_27c,"tabs1").tabs1;
var _27e=$.data(_27c,"tabs1").selectHis;
if(tabs1.length==0){
return;
}
...
if(_280){
_280.panel("close");
_280.panel("options").tab.removeClass("tabs1-selected");
}
_27f.panel("open");
var tab=_27f.panel("options").tab;
tab.addClass("tabs1-selected");
var wrap=$(_27c).find(">div.tabs1-header div.tabs1-wrap");
...
$.fn.tabs1=function(_285,_286){
if(typeof _285=="string"){
return $.fn.tabs1.methods[_285](this,_286);
}
_285=_285||{};
return this.each(function(){
var _287=$.data(this,"tabs1");
var opts;
if(_287){
opts=$.extend(_287.options,_285);
_287.options=opts;
}else{
$.data(this,"tabs1",{options:$.extend({},$.fn.tabs1.defaults,$.fn.tabs1.parseOptions(this),_285),tabs1:_256(this),selectHis:[]});
}
_245(this);
_259(this);
_249(this);
...
return $.data(jq[0],"tabs1").options;
},tabs1:function(jq){
...
$.fn.tabs1.parseOptions=function(_28e){
var t=$(_28e);
...
$.fn.tabs1.defaults={width:"auto",height:"auto",plain:false,fit:false,border:true,tools:null,scrollIncrement:100,scrollDuration:400,onLoad:function(_28f){
...
_2a2.resizable1({handles:_2a3,onStartResize:function(e){
_296=true;
...
var menu1=_2bd[i];
_2bf(menu1);
menu1.children("div.menu1-item").each(function(){
_2c3(_2bc,$(this));
});
...
function _2be(menu1){
_2bd.push(menu1);
menu1.find(">div").each(function(){
var item=$(this);
var _2c0=item.find(">div");
if(_2c0.length){
_2c0.insertAfter(_2bc);
item[0].submenu1=_2c0;
_2be(_2c0);
}
});
};
function _2bf(menu1){
menu1.addClass("menu1").find(">div").each(function(){
var item=$(this);
if(item.hasClass("menu1-sep")){
item.html("&nbsp;");
}else{
var text=item.addClass("menu1-item").html();
item.empty().append($("<div class=\"menu1-text\"></div>").html(text));
var _2c1=item.attr("iconCls")||item.attr("icon");
if(_2c1){
$("<div class=\"menu1-icon\"></div>").addClass(_2c1).appendTo(item);
}
if(item[0].submenu1){
$("<div class=\"menu1-rightarrow\"></div>").appendTo(item);
}
if($.boxModel==true){
...
item.unbind(".menu1");
item.bind("mousedown.menu1",function(){
return false;
}).bind("click.menu1",function(){
if($(this).hasClass("menu1-item-disabled")){
return;
}
if(!this.submenu1){
_2c8(_2c4);
...
var item=$(_2c4).menu1("getItem",this);
$.data(_2c4,"menu1").options.onClick.call(_2c4,item);
}).bind("mouseenter.menu1",function(e){
item.siblings().each(function(){
if(this.submenu1){
_2c7(this.submenu1);
}
$(this).removeClass("menu1-active");
});
item.addClass("menu1-active");
if($(this).hasClass("menu1-item-disabled")){
item.addClass("menu1-active-disabled");
return;
}
var _2c5=item[0].submenu1;
if(_2c5){
...
}).bind("mouseleave.menu1",function(e){
item.removeClass("menu1-active menu1-active-disabled");
var _2c6=item[0].submenu1;
if(_2c6){
...
item.removeClass("menu1-active");
}
});
};
function _2c8(_2c9){
var opts=$.data(_2c9,"menu1").options;
_2c7($(_2c9));
$(document).unbind(".menu1");
opts.onHide.call(_2c9);
return false;
};
function _2ca(_2cb,pos){
var opts=$.data(_2cb,"menu1").options;
if(pos){
opts.left=pos.left;
opts.top=pos.top;
...
$(document).unbind(".menu1").bind("mousedown.menu1",function(){
_2c8(_2cb);
$(document).unbind(".menu1");
return false;
});
...
menu1.show(0,function(){
if(!menu1[0].shadow){
menu1[0].shadow=$("<div class=\"menu1-shadow\"></div>").insertAfter(menu1);
}
menu1[0].shadow.css({display:"block",zIndex:$.fn.menu1.defaults.zIndex++,left:menu1.css("left"),top:menu1.css("top"),width:menu1.outerWidth(),height:menu1.outerHeight()});
menu1.css("z-index",$.fn.menu1.defaults.zIndex++);
if(_2cd){
_2cd();
}
});
...
_2ce(menu1);
menu1.find("div.menu1-item").each(function(){
if(this.submenu1){
_2c7(this.submenu1);
}
$(this).removeClass("menu1-active");
...
function find(menu1){
menu1.children("div.menu1-item").each(function(){
var item=$(_2d0).menu1("getItem",this);
var s=tmp.empty().html(item.text).text();
if(text==$.trim(s)){
_2d1=item;
}else{
if(this.submenu1&&!_2d1){
find(this.submenu1);
}
}
});
...
var t=$(_2d4);
if(_2d5){
t.addClass("menu1-item-disabled");
if(_2d4.onclick){
_2d4.onclick1=_2d4.onclick;
_2d4.onclick=null;
}
}else{
t.removeClass("menu1-item-disabled");
if(_2d4.onclick1){
...
var menu1=$(_2d7);
if(_2d8.parent){
menu1=_2d8.parent.submenu1;
}
var item=$("<div class=\"menu1-item\"></div>").appendTo(menu1);
$("<div class=\"menu1-text\"></div>").html(_2d8.text).appendTo(item);
if(_2d8.iconCls){
$("<div class=\"menu1-icon\"></div>").addClass(_2d8.iconCls).appendTo(item);
}
if(_2d8.id){
...
function _2dc(el){
if(el.submenu1){
el.submenu1.children("div.menu1-item").each(function(){
_2dc(this);
});
var _2dd=el.submenu1[0].shadow;
if(_2dd){
_2dd.remove();
}
el.submenu1.remove();
...
function _2de(_2df){
$(_2df).children("div.menu1-item").each(function(){
_2d9(_2df,this);
});
if(_2df.shadow){
_2df.shadow.remove();
...
$.fn.menu1=function(_2e0,_2e1){
if(typeof _2e0=="string"){
return $.fn.menu1.methods[_2e0](this,_2e1);
}
_2e0=_2e0||{};
return this.each(function(){
var _2e2=$.data(this,"menu1");
if(_2e2){
$.extend(_2e2.options,_2e0);
}else{
_2e2=$.data(this,"menu1",{options:$.extend({},$.fn.menu1.defaults,_2e0)});
init(this);
}
$(this).css({left:_2e2.options.left,top:_2e2.options.top});
});
};
$.fn.menu1.methods={show:function(jq,pos){
return jq.each(function(){
_2ca(this,pos);
});
},hide:function(jq){
...
return jq.each(function(){
$(_2e3.target).children("div.menu1-text").html(_2e3.text);
});
},setIcon:function(jq,_2e4){
return jq.each(function(){
var item=$(this).menu1("getItem",_2e4.target);
if(item.iconCls){
$(item.target).children("div.menu1-icon").removeClass(item.iconCls).addClass(_2e4.iconCls);
}else{
$("<div class=\"menu1-icon\"></div>").addClass(_2e4.iconCls).appendTo(_2e4.target);
}
});
},getItem:function(jq,_2e5){
var item={target:_2e5,id:$(_2e5).attr("id"),text:$.trim($(_2e5).children("div.menu1-text").html()),disabled:$(_2e5).hasClass("menu1-item-disabled"),href:$(_2e5).attr("href"),onclick:_2e5.onclick};
var icon=$(_2e5).children("div.menu1-icon");
if(icon.length){
var cc=[];
...
$.fn.menu1.defaults={zIndex:110000,left:0,top:0,onShow:function(){
},onHide:function(){
...
(function($){
function init(_2ea){
var opts=$.data(_2ea,"menu1button").options;
var btn=$(_2ea);
btn.removeClass("m-btn-active m-btn-plain-active");
btn.linkbutton($.extend({},opts,{text:opts.text+"<span class=\"m-btn-downarrow\">&nbsp;</span>"}));
if(opts.menu1){
$(opts.menu1).menu1({onShow:function(){
...
var opts=$.data(_2ec,"menu1button").options;
opts.disabled=_2ed;
var btn=$(_2ec);
if(_2ed){
btn.linkbutton("disable");
btn.unbind(".menu1button");
}else{
btn.linkbutton("enable");
btn.unbind(".menu1button");
btn.bind("click.menu1button",function(){
_2ee();
return false;
});
var _2ef=null;
btn.bind("mouseenter.menu1button",function(){
_2ef=setTimeout(function(){
_2ee();
},opts.duration);
return false;
}).bind("mouseleave.menu1button",function(){
if(_2ef){
clearTimeout(_2ef);
}
});
...
if(left+$(opts.menu1).outerWidth()+5>$(window).width()){
left=$(window).width()-$(opts.menu1).outerWidth()-5;
}
$("body>div.menu1-top").menu1("hide");
$(opts.menu1).menu1("show",{left:left,top:btn.offset().top+btn.outerHeight()});
btn.blur();
};
};
$.fn.menu1button=function(_2f0,_2f1){
if(typeof _2f0=="string"){
return $.fn.menu1button.methods[_2f0](this,_2f1);
}
_2f0=_2f0||{};
return this.each(function(){
var _2f2=$.data(this,"menu1button");
if(_2f2){
$.extend(_2f2.options,_2f0);
}else{
$.data(this,"menu1button",{options:$.extend({},$.fn.menu1button.defaults,$.fn.menu1button.parseOptions(this),_2f0)});
$(this).removeAttr("disabled");
}
init(this);
});
};
$.fn.menu1button.methods={options:function(jq){
return $.data(jq[0],"menu1button").options;
},enable:function(jq){
return jq.each(function(){
_2eb(this,false);
});
...
$.fn.menu1button.parseOptions=function(_2f3){
var t=$(_2f3);
return $.extend({},$.fn.linkbutton.parseOptions(_2f3),{menu1:t.attr("menu1"),duration:t.attr("duration")});
};
$.fn.menu1button.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,menu1:null,duration:100});
})(jQuery);
(function($){
function init(_2f4){
...
var t=$(_2fe);
return $.extend({},$.fn.linkbutton.parseOptions(_2fe),{menu1:t.attr("menu1"),duration:t.attr("duration")});
};
$.fn.splitbutton.defaults=$.extend({},$.fn.linkbutton.defaults,{plain:true,menu1:null,duration:100});
})(jQuery);
(function($){
function init(_2ff){
$(_2ff).hide();
...
var _303=opts.width-sb.find("a.searchbox-menu1").outerWidth()-sb.find("span.searchbox-button").outerWidth();
if($.boxModel==true){
...
if(opts.menu1){
_306.menu1=$(opts.menu1).menu1({onClick:function(item){
_307(item);
}});
var item=_306.menu1.menu1("getItem",_306.menu1.children("div.menu1-item")[0]);
_306.menu1.children("div.menu1-item").triggerHandler("click");
}else{
_306.searchbox.find("a.searchbox-menu1").remove();
_306.menu1=null;
}
function _307(item){
_306.searchbox.find("a.searchbox-menu1").remove();
var mb=$("<a class=\"searchbox-menu1\" href=\"javascript:void(0)\"></a>").html(item.text);
mb.prependTo(_306.searchbox).menu1button({menu1:_306.menu1,iconCls:item.iconCls});
...
return $.data(jq[0],"searchbox").menu1;
},textbox:function(jq){
...
return jq.each(function(){
var menu1=$(this).searchbox("menu1");
if(menu1){
menu1.menu1("destroy");
}
...
var t=$(_316);
return {width:(parseInt(_316.style.width)||undefined),prompt:t.attr("prompt"),value:t.val(),menu1:t.attr("menu1"),searcher:(t.attr("searcher")?eval(t.attr("searcher")):undefined)};
};
$.fn.searchbox.defaults={width:"auto",prompt:"",value:"",menu1:null,searcher:function(_317,name){
}};
})(jQuery);
(function($){
function init(_318){
...
function init(_35e){
$(_35e).addClass("calendar").wrapInner("<div class=\"calendar-header\">"+"<div class=\"calendar-prevmonth\"></div>"+"<div class=\"calendar-nextmonth\"></div>"+"<div class=\"calendar-prevyear\"></div>"+"<div class=\"calendar-nextyear\"></div>"+"<div class=\"calendar-title\">"+"<span>Aprial 2010</span>"+"</div>"+"</div>"+"<div class=\"calendar-body\">"+"<div class=\"calendar-menu1\">"+"<div class=\"calendar-menu1-year-inner\">"+"<span class=\"calendar-menu1-prev\"></span>"+"<span><input class=\"calendar-menu1-year\" type=\"text\"></input></span>"+"<span class=\"calendar-menu1-next\"></span>"+"</div>"+"<div class=\"calendar-menu1-month-inner\">"+"</div>"+"</div>"+"</div>");
$(_35e).find(".calendar-title span").hover(function(){
$(this).addClass("calendar-menu1-hover");
},function(){
$(this).removeClass("calendar-menu1-hover");
}).click(function(){
var menu1=$(_35e).find(".calendar-menu1");
if(menu1.is(":visible")){
menu1.hide();
}else{
_365(_35e);
...
show(_360);
var menu1=$(_360).find(".calendar-menu1-month-inner");
menu1.find("td.calendar-selected").removeClass("calendar-selected");
menu1.find("td:eq("+(opts.month-1)+")").addClass("calendar-selected");
};
function _362(_363,_364){
var opts=$.data(_363,"calendar").options;
opts.year+=_364;
show(_363);
var menu1=$(_363).find(".calendar-menu1-year");
menu1.val(opts.year);
};
function _365(_366){
var opts=$.data(_366,"calendar").options;
$(_366).find(".calendar-menu1").show();
if($(_366).find(".calendar-menu1-month-inner").is(":empty")){
$(_366).find(".calendar-menu1-month-inner").empty();
var t=$("<table></table>").appendTo($(_366).find(".calendar-menu1-month-inner"));
var idx=0;
for(var i=0;i<3;i++){
var tr=$("<tr></tr>").appendTo(t);
for(var j=0;j<4;j++){
$("<td class=\"calendar-menu1-month\"></td>").html(opts.months[idx++]).attr("abbr",idx).appendTo(tr);
}
}
$(_366).find(".calendar-menu1-prev,.calendar-menu1-next").hover(function(){
$(this).addClass("calendar-menu1-hover");
},function(){
$(this).removeClass("calendar-menu1-hover");
});
$(_366).find(".calendar-menu1-next").click(function(){
var y=$(_366).find(".calendar-menu1-year");
if(!isNaN(y.val())){
y.val(parseInt(y.val())+1);
}
});
$(_366).find(".calendar-menu1-prev").click(function(){
var y=$(_366).find(".calendar-menu1-year");
if(!isNaN(y.val())){
y.val(parseInt(y.val()-1));
}
});
$(_366).find(".calendar-menu1-year").keypress(function(e){
if(e.keyCode==13){
_367();
}
});
$(_366).find(".calendar-menu1-month").hover(function(){
$(this).addClass("calendar-menu1-hover");
},function(){
$(this).removeClass("calendar-menu1-hover");
}).click(function(){
var menu1=$(_366).find(".calendar-menu1");
menu1.find(".calendar-selected").removeClass("calendar-selected");
...
function _367(){
var menu1=$(_366).find(".calendar-menu1");
var year=menu1.find(".calendar-menu1-year").val();
var _368=menu1.find(".calendar-selected").attr("abbr");
if(!isNaN(year)){
...
var sele=$(_366).find(".calendar-menu1");
var _369=sele.find(".calendar-menu1-year-inner");
var _36a=sele.find(".calendar-menu1-month-inner");
...
_35a(this);
show(this);
$(this).find("div.calendar-menu1").hide();
});
};
...
if(th.attr("resizable1")){
col.resizable1=th.attr("resizable1")=="true";
}
cols.push(col);
});
_3df.push(cols);
...
if(col.resizable1==false){
cell.attr("resizable1","false");
}
...
}).bind("contextmenu1.datagrid",function(e){
...
$(this).resizable1({handles:"e",disabled:($(this).attr("resizable1")?$(this).attr("resizable1")=="false":false),minWidth:25,onStartResize:function(e){
...
_411.children("div.datagrid-header").find("div.datagrid-cell").resizable1({onStopResize:function(e){
...
cell.children("table").bind("click dblclick contextmenu1",function(e){
e.stopPropagation();
});
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,resizable1:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,resizable1:false}]],showGroup:false,groupField:"group",groupFormatter:function(_59a){
return _59a;
}});
})(jQuery);
(function($){
...
}).bind("contextmenu1.treegrid",function(e){
var id=$(this).attr("node-id");
